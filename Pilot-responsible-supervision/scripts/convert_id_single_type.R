# From Maia Salholz-Hillel (https://github.com/quest-bih/IntoValue2/blob/master/code/2_dataset_cleaning/functions/convert_id_single_type.R)

#' Convert publication ids using the [Fatcat](https://fatcat.wiki/) [API](https://api.fatcat.wiki/)
#'
